...
_TRAFFICPOLICY_PORTTRAFFICPOLICY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='inbound_connection_pool', full_name='istio.networking.v1alpha3.TrafficPolicy.PortTrafficPolicy.inbound_connection_pool', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='outlier_detection', full_name='istio.networking.v1alpha3.TrafficPolicy.PortTrafficPolicy.outlier_detection', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tls', full_name='istio.networking.v1alpha3.TrafficPolicy.PortTrafficPolicy.tls', index=5,
...
_TRAFFICPOLICY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='inbound_connection_pool', full_name='istio.networking.v1alpha3.TrafficPolicy.inbound_connection_pool', index=2,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='outlier_detection', full_name='istio.networking.v1alpha3.TrafficPolicy.outlier_detection', index=3,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tls', full_name='istio.networking.v1alpha3.TrafficPolicy.tls', index=4,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='port_level_settings', full_name='istio.networking.v1alpha3.TrafficPolicy.port_level_settings', index=5,
...
_TRAFFICPOLICY_PORTTRAFFICPOLICY.fields_by_name['inbound_connection_pool'].message_type = _CONNECTIONPOOLSETTINGS
...
_TRAFFICPOLICY.fields_by_name['inbound_connection_pool'].message_type = _CONNECTIONPOOLSETTINGS
